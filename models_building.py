...
# Datasets path
true_dataset_path = 'dataset/training_dataset/True.csv'
fake_dataset_path = 'dataset/training_dataset/Fake.csv'
...
filename = 'trained_models/logistic_regression_fnd.pkl'
...
filename = 'trained_models/decision_tree_classifier_fnd.pkl'
...
filename = 'trained_models/gradient_boosting_classifier_fnd.pkl'
...
filename = 'trained_models/random_forest_classifier_fnd.pkl'
